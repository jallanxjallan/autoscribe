...
- build, normalize, hash, or cache a dispatch payload;
...
- perform shadow-tree synchronization itself;
...
| File State | file-state query | Git, shadow, dispatch, response state |
